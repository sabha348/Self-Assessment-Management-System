...
const API_URL = process.env.REACT_APP_API_URL || "http://localhost:8000/api/timetable";
...
export const updateTimetableEntry = async (data, token) => {
  try {
    const response = await axios.put(`${API_URL}/timetable`, data, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return response.data;
  } catch (error) {
...
export const updateSubject = async (data, token) => {
  try {
    const response = await axios.put(`${API_URL}/timetable/update-subject`, data, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return response.data;
  } catch (error) {
...
export const deleteSubject = async (data, token) => {
  try {
    const response = await axios.put(`${API_URL}/timetable/delete-subject`, data, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return response.data;
  } catch (error) {
